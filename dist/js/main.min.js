...
window.Modernizr = function(a, b, c) {
    ...
    function z() {
        e.input = function(c) {
            for (var d = 0, e = c.length; d < e; d++) o[c[d]] = c[d] in k;
            return o.list && (o.list = !!b.createElement("datalist") && !!a.HTMLDataListElement), 
            o;
        }("autocomplete autofocus list placeholder max min multiple pattern required step".split(" "));
    }
    var d = "2.8.3", e = {}, f = !0, g = b.documentElement, h = "modernizr", i = b.createElement(h), j = i.style, k = b.createElement("input"), l = {}.toString, m = {}, n = {}, o = {}, p = [], q = p.slice, r, s = {}.hasOwnProperty, t;
    ...
    return e.input || z(), e.addTest = function(a, b) {
        ...
        a.html5 = s, r(b);
    }(this, b), e._version = d, g.className = g.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (f ? " js " + p.join(" ") : ""), 
    e;
...
$(document).ready(function() {
    ...
    function check_date_year(check_date) {
        var split_date = check_date.split("/");
        var dd = parseInt(split_date[0]);
        var mm = parseInt(split_date[1] - 1);
        //months zero based
        var yy = parseInt(split_date[2]);
